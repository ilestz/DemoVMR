...
export default class TitleScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('minus1', 'assets/minus1.png')
    this.load.image('plus1s', 'assets/plus1Scram.png')
    this.load.image('minus1s', 'assets/minus1Scram.png')
    // load sounds
    this.load.audio('ding', 'assets/correct.wav')
    this.load.audio('buzz', 'assets/incorrect.wav')
    this.load.audio('clap', 'assets/neutral.wav')
    this.load.audio('too-slow', 'assets/too_slow.wav')
  }
  create() {
